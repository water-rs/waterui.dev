export const navigation = [
  { label: "API", href: "https://docs.waterui.dev" },
  { label: "Book", href: "https://book.waterui.dev" },
] as const;
...
export const cliWorkflows = [
  ...
  },
  {
    ...
    description:
      "Launch synchronized live builds across mobile and desktop shell.",
    command: "water run",
    accent: "red",
  },
  {
...
export const cliPlaybooks = [
  {
    ...
    summary:
      "Spin up a synchronized project frame for SwiftUI, GTK4, Android, and canvas targets.",
    details: [
  ...
  },
  {
    ...
    summary:
      "Preview layout experiments, motion, and typography without leaving the terminal.",
    details: [
  ...
  },
  {
    ...
    summary:
      "Bundle binaries, assets, and metadata from one manifest-driven pipeline.",
    details: [
...
export const cliHighlights = [
  {
    ...
    summary:
      "Scaffold SwiftUI, GTK4, Android, and canvas shells from a single manifest.",
    details: [
  ...
  },
  {
    ...
    summary:
      "Hot reload and watch services mirror design tweaks on every device.",
    details: [
  ...
  },
  {
    ...
    summary:
      "Publish binaries, assets, and telemetry with a reproducible CLI ritual.",
    details: [
...
export const cliSurfaceChannels = [
  {
    ...
    signal: "Green",
    description:
      "Live previews respond instantly with native typography and navigation.",
  },
  {
    value: "gtk4",
    label: "GTK4",
    ...
    signal: "Amber",
    description:
      "Desktop shell awaiting motion verification before the next drop.",
  },
  {
    value: "android",
    label: "Android",
  ...
  },
  {
    ...
    signal: "Violet",
    description:
      "Self-rendering preview labs exploring fluid typography rendering.",
  },
] as const;
...
export const cliSignalBands = [
  {
    ...
    title: "Draft mode",
    message:
      "Focus on wiring data contracts and instrumentation before broadcasting builds.",
    accent: "red",
  },
  {
    id: "review",
    ...
    title: "In review",
    message:
      "Design, platform, and QA signals are syncing — expect rapid iteration cycles.",
    accent: "yellow",
  },
  {
    id: "go",
    ...
    title: "Go for launch",
    message:
      "All surfaces are synchronized with healthy telemetry. Prep release notes and flip the switch.",
    accent: "blue",
  },
] as const;
...
export const roadmapMilestones = [
  {
    ...
    status: "Shipped",
    summary:
      "The inaugural release delivering core widgets, layouts, and the initial cross-platform story.",
    accent: "blue",
  },
  {
    version: "0.2 Usable",
